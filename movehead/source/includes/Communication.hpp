...
class Communication {
	...
	private:
		...
		simxInt naoJointsIds0[41], naoJointsIds1[41], naoJointsIds2[41], oppRobotsIds[3], headsIds[3];
		simxInt ballId;
		simxFloat ballCoords[3], robot0Coords[3], robot1Coords[3], robot2Coords[3], robot0Orient[3], robot1Orient[3], robot2Orient[3], opp0Coords[3], opp1Coords[3], opp2Coords[3], opp0Orient[3], opp1Orient[3], opp2Orient[3];
		std::vector<std::string> robot0{"HeadYaw#0", "HeadPitch#0", "LHipYawPitch3#0", "LHipRoll3#0", "LHipPitch3#0", "LKneePitch3#0", "LAnklePitch3#0", "LAnkleRoll3#0", "RHipYawPitch3#0", "RHipRoll3#0", "RHipPitch3#0", "RKneePitch3#0", "RAnklePitch3#0", "RAnkleRoll3#0", "LShoulderPitch3#0", "LShoulderRoll3#0", "LElbowYaw3#0", "LElbowRoll3#0", "LWristYaw3#0", "RShoulderPitch3#0", "RShoulderRoll3#0", "RElbowYaw3#0",  "RElbowRoll3#0", "RWristYaw3#0"};
		std::vector<std::string> robot1{"HeadYaw#", "HeadPitch#1", "LHipYawPitch3#1", "LHipRoll3#1", "LHipPitch3#1", "LKneePitch3#1", "LAnklePitch3#1", "LAnkleRoll3#1", "RHipYawPitch3#1", "RHipRoll3#1", "RHipPitch3#1", "RKneePitch3#1", "RAnklePitch3#1", "RAnkleRoll3#1", "LShoulderPitch3#1", "LShoulderRoll3#1", "LElbowYaw3#1", "LElbowRoll3#1", "LWristYaw3#1", "RShoulderPitch3#1", "RShoulderRoll3#1", "RElbowYaw3#1",  "RElbowRoll3#1", "RWristYaw3#1"};
		std::vector<std::string> robot2{"HeadYaw#2", "HeadPitch#2", "LHipYawPitch3#2", "LHipRoll3#2", "LHipPitch3#2", "LKneePitch3#2", "LAnklePitch3#2", "LAnkleRoll3#2", "RHipYawPitch3#2", "RHipRoll3#2", "RHipPitch3#2", "RKneePitch3#2", "RAnklePitch3#2", "RAnkleRoll3#2", "LShoulderPitch3#2", "LShoulderRoll3#2", "LElbowYaw3#2", "LElbowRoll3#2", "LWristYaw3#2", "RShoulderPitch3#2", "RShoulderRoll3#2", "RElbowYaw3#2",  "RElbowRoll3#2", "RWristYaw3#2"};
